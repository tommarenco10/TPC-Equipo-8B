...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>Plantel de Primera</h1>

    <asp:GridView runat="server" ID="dgvPrimera" CssClass="table" AutoGenerateColumns="false" OnSelectedIndexChanged="dgv_SelectedIndexChanged">
        <Columns>
    ...
    <h1>Plantel de Reserva</h1>

    <asp:GridView runat="server" ID="dgvReserva" CssClass="table" AutoGenerateColumns="false" OnSelectedIndexChanged="dgv_SelectedIndexChanged">
        <Columns>
            <asp:BoundField HeaderText="Nombre" DataField="Nombres" />
            <asp:BoundField HeaderText="Apellido" DataField="Apellidos" />
            <asp:BoundField HeaderText="Fecha de nacimiento" DataField="FechaNacimiento" />
    ...
    <asp:GridView runat="server" ID="dgvJuveniles" CssClass="table" AutoGenerateColumns="false" OnSelectedIndexChanged="dgv_SelectedIndexChanged">
        <Columns>
            <asp:BoundField HeaderText="Nombre" DataField="Nombres" />
            <asp:BoundField HeaderText="Apellido" DataField="Apellidos" />
            <asp:BoundField HeaderText="Fecha de nacimiento" DataField="FechaNacimiento" />
